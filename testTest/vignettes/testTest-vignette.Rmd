...
The sole purpuse of this tiny packacge (only 4 lines of code) is to demonstrate a 'devtools' 
problem by showing different verdicts made by 3 kinds of tests.

A work around is provided as well.
...
The problem is reported in https://github.com/r-lib/devtools/issues/2577  as well.

## 2. Overview

1. The intended behaviour of this package is demonstrated.

2. The test file use for all tests

3. The 'setMenu' function is tested with a simple use of 'testthat' This works well.

4. The 'setMenu' function is tested with 'rcmdcheck()' Which works well.

5. The 'setMenu' function is tested with 'devtools' Which caused a problem.     

6. Concluding considerations     

7. A simple remedy

## 3.1. Demonstration of the testest package
...
## 3.2 The test file use for all tests
...
## 3.3 A simple test with testthat
...
## 3.4 Running rcmdcheck::rcmdcheck()
